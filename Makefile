...
IMAGE_NAME_BUILDER_REF := $(IMAGE_NAME_BUILDER):$(GIT_REF)_$(TARGET_ARCH)
IMAGE_NAME_BUILDER_COMMIT := $(IMAGE_NAME_BUILDER):$(GIT_COMMIT)_$(TARGET_ARCH)
IMAGE_NAME_BUILDER_LATEST := $(IMAGE_NAME_BUILDER):latest_$(TARGET_ARCH)

IMAGE_NAME_DRIVERKIT ?= docker.io/$(DOCKER_ORG)/driverkit

IMAGE_NAME_DRIVERKIT_REF := $(IMAGE_NAME_DRIVERKIT):$(GIT_REF)_$(TARGET_ARCH)
IMAGE_NAME_DRIVERKIT_COMMIT := $(IMAGE_NAME_DRIVERKIT):$(GIT_COMMIT)_$(TARGET_ARCH)
IMAGE_NAME_DRIVERKIT_LATEST := $(IMAGE_NAME_DRIVERKIT):latest_$(TARGET_ARCH)
...
test_configs := $(wildcard test/$(TARGET_ARCH)/configs/*.yaml)
